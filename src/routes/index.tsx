...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white antialiased selection:bg-[#22C55E]/30">
      <div className="bg-yellow-400 p-2 text-center text-xs font-bold text-black">'nao e para colocar oque estou enviando em um banner, e para executar' (on element 'body' at '/src/routes/index.tsx:1')</div>
      {/* Bloco 1 — Topo */}
